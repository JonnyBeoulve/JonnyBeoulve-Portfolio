    ...
    <section className="spotlight">
      ...
      <section className="spotlight">
        ...
        <div className="content">
          ...
          <p>
            <a href="https://spacex-f.firebaseapp.com/" target="_blank" rel="noopener noreferrer"
      ...
      <section className="spotlight">
        ...
        <div className="content">
          ...
          <p>
            <a href="http://www.jonathanleack.com/flight/" target="_blank" rel="noopener noreferrer"
              >Demo Flight</a
            >
          </p>
          <p>
      ...
      <section className="spotlight">
        ...
        <div className="content">
          ...
          <p>
            <a href="https://gametrial.herokuapp.com/" target="_blank" rel="noopener noreferrer"
              >Demo GameTrial</a>
          </p>
        </div>
      </section>
      ...
      <section className="spotlight">
        ...
        <div className="content">
          ...
          <p>
            <a href="https://www.glynnedavies.com/" target="_blank" rel="noopener noreferrer"
      ...
      <section className="spotlight">
        ...
        <div className="content">
          ...
          <p>
            <a
              href="http://www.gamerevolution.com/g00/features/13618-valve-interview-roundtable" target="_blank" rel="noopener noreferrer"
